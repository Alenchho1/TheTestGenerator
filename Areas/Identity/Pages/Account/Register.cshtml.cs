...
namespace TestGenerator.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        private ApplicationUser CreateUser()
        {
            ...
            catch
            {
                throw new InvalidOperationException($"Не може да се създаде инстанция на '{nameof(ApplicationUser)}'. " +
                    $"Уверете се, че '{nameof(ApplicationUser)}' не е абстрактен клас и има конструктор без параметри, или " +
        ...
        private IUserEmailStore<ApplicationUser> GetEmailStore()
        {
            ...
            {
                throw new NotSupportedException("Потребителското хранилище трябва да поддържа имейли.");
            }
